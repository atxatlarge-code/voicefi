...
**Audio Master:** `Shinra B - SOCIETY (90s Boom Bap Beat) [85 BPM].mp3`  

---

## 🎞️ 1. VISUAL BIBLE & ART DIRECTION SYSTEM

### 🎨 Visual Identity & Film Stock
* **Primary Film Stock:** 35mm Kodak Vision3 500T (5219) & Kodak Portra 400 aesthetic. Organic gate weave, 35mm grain structure, warm halation on high-contrast specular highlights.
* **Aspect Ratios:** 
  * **Master Cinematic:** 2.39:1 Anamorphic Widescreen (Letterboxed on 16:9).
  * **Social Reels / TikTok / Shorts:** 9:16 Vertical Crop with locked central-action framing and anchored upper/lower UI margins.
* **Color Grading Palette:**
  * `Ochre Gold & Terracotta`: `#D97724`, `#C25E1A` (Texas sunset, limestone cliffs at golden hour)
  * `Pedernales Aqua`: `#1E6B7B`, `#0F4C5C` (Cold spring water, deep river channel)
  * `Smoker Charcoal`: `#1C1A17`, `#2D2721` (Offset smoker steel, post-oak bark, brisket crust)
  * `Texas Bluebonnet Indigo`: `#2C3E8A` (Wildflower patches, twilight sky)
  * `Vintage Cream`: `#F5EBE0` (Weathered road signs, rustic canvas, vintage typography)

### 🎸 Wardrobe & Character Design
* **Lead MC / Performer:**
  * Distressed 1990s Carhartt Detroit Duck Jacket (Carhartt brown with corduroy collar), faded Levi's 501s, vintage Red Wing iron ranger boots.
  * Headwear: Weathered Stetson Open Road hat or vintage navy Houston Astros snapback.
  * Accessories: Sterling silver turquoise ring, worn leather guitar strap, vintage Shure 55SH "Elvis" chrome microphone with wrapped red bandana.
* **Supporting Cast & Locals:**
...
## 🗺️ 2. SCENE-BY-SCENE STORYBOARD & SHOT LIST (BARS 1–102)

```
========================================================================================
TIMELINE OVERVIEW:
Act I   │ Bars 1–20   │ 0:00 – 0:56  │ The Rural Inception (Hwy 71, Krause, Pedernales)
Act II  │ Bars 21–52  │ 0:56 – 2:27  │ The Outlaw Anthem & 8-Bar Mega Speed Burst
Act III │ Bars 53–79  │ 2:27 – 3:44  │ Sunset Storyteller, Outlaw Banter & Heavy Drop
Outro   │ Bars 80–102 │ 3:44 – 4:48  │ Porch Session, Crickets & Vinyl Dust
========================================================================================
```

---

### 📍 ACT I: THE RURAL INCEPTION

#### [Intro: Bars 1–4] ⏱️ 0:00 – 0:11 (4 Bars / 11.3s)
*Audio: Dusty vinyl crackle, warm Rhodes piano chords, lighter flick, heavy truck door shut, spoken drawl.*

* **Bar 1 (0:00 – 0:03) | Shot 1.1 [Macro Insert]:**
  * **Visual:** Extreme macro shot of a diamond stylus needle dropping into the groove of a dusty 12-inch vinyl record spinning on a Technics SL-1200MK2. Fine dust particles dancing in a single shaft of afternoon sunlight.
  * **Motion:** Subtle slow push-in.
  * **Graphics:** Green phosphor VHS OSD in upper left: `PLAY [▶] SP  00:00:01:00`.
  * **Lyric/Audio:** *(Vinyl crackle, piano rings out)*

* **Bar 2 (0:03 – 0:06) | Shot 1.2 [Cinematic Establishing Wide]:**
  * **Visual:** Low-angle 24mm anamorphic wide shot of two-lane Texas Highway 71 cutting through rolling limestone cedar hills. A vintage two-tone 1978 Ford F-150 rumbles toward the lens under golden heat mirage.
  * **Motion:** Static camera; truck passes overhead with a heavy low-end tire rumble.
...
#### [Verse 1: Bars 5–20] ⏱️ 0:11 – 0:56 (16 Bars / 45.2s)

##### 🔹 Part A: Machine-Gun Internal Stack (Bars 5–12 / 0:11 – 0:34)
*Editing Rhythm: Rapid machine-gun cuts snapping exactly on beat 1 and beat 3, with visual whip-cracks on beat 2 and beat 4!*
...
* **Bar 8 (0:20 – 0:22) | Shot 1.8 [FPV Drone Dive]:**
  * **0:20 [1]:** FPV drone dives down the limestone gorge of Pedernales Falls, skimming inches above rushing white water rapids.
  * **0:21 [2 💥]:** Drone banks 90 degrees around ancient granite boulders.
  * **0:22 [4 💥]:** Match-cut to aerial top-down view of the Colorado River channel: *"COLORADO"*.

* **Bar 9 (0:22 – 0:25) | Shot 1.9 [Outlaw Heritage]:**
  * **0:22 [1]:** Rusty five-strand barbed wire fence in foreground, weathered cedar fence posts.
  * **0:23 [2 💥]:** Sun-bleached Texas lone star flag painted on corrugated barn tin.
  * **0:25 [4 💥]:** MC steps out from behind the barn post with microphone in hand: *"BIG BRAVADO"*.

* **Bar 10 (0:25 – 0:28) | Shot 1.10 [Canopy & Roots]:**
  * **0:25 [1]:** Tilt up a colossal 500-year-old bald cypress trunk along the riverbank.
  * **0:26 [2 💥]:** Massive cypress roots twisting into the limestone bank like knotted muscle.
...
* **Bar 12 (0:31 – 0:34) | Shot 1.12 [Beatmaker Tribute]:**
  * **0:31 [1]:** Close-up on an Akai MPC 3000 sitting on the tailgate of the Ford truck.
  * **0:32 [2 💥]:** MC's hand strikes drum pad 1 (Kick) and drum pad 2 (Snare) in perfect sync with the audio beat!
  * **0:34 [4 💥]:** Cut to a wild quarter horse galloping along the fence line: *"LIKE TONTO!"*.

---

##### 🔹 Part B: Conversational Outlaw Groove (Bars 13–20 / 0:34 – 0:56)
*Editing Rhythm: Smooth 4-second tracking shots and sweeping steadicam moves, letting the Texas atmosphere expand.*

* **Bar 13 (0:34 – 0:37) | Shot 1.13 [Steadicam Walk]:**
  * **Visual:** Steadicam tracking backwards in front of the MC as he strolls down the rustic dirt lane of Luck, Texas. Weathered false-front saloon buildings behind him.
  * **Lyric:** *"'Round here is outlaw country, MAKE NO MISTAKE"* (hits Beat 4 snare on *MISTAKE*).

* **Bar 14 (0:37 – 0:40) | Shot 1.14 [Scenic Reveal Crane]:**
  * **Visual:** Camera rises up over a limestone bluff to reveal the vast expanse of Lake Travis shimmering in afternoon teal and blue.
  * **Lyric:** *"'Round here we don't call 'em rivers, WE CALL 'EM LAKES!"*.

* **Bar 15 (0:40 – 0:42) | Shot 1.15 [Dust & Tires]:**
  * **Visual:** Ford pickup truck skids to a halt on a caliche dirt road. Red brake lights flare through a thick cloud of chalk-white limestone dust.
  * **Lyric:** *"Slow down in Pedernales, HIT YOUR CEDAR BREAKS"*.

* **Bar 16 (0:42 – 0:45) | Shot 1.16 [Rope Swing Slow-Mo]:**
...
### 📍 ACT II: THE OUTLAW ANTHEM & MEGA SPEED BURST

#### [Hook 1: Bars 21–28] ⏱️ 0:56 – 1:19 (8 Bars / 22.6s)
*Editing Rhythm: Half-time cinematic anthem! The camera holds steady, building massive tension, until the 4th-beat snare crack [4 💥] unleashes a visual punch on every measure.*

| Measure | Timestamp | Visual Action & Framing | Beat 4 Accent Cue [4 💥] |
| :--- | :--- | :--- | :--- |
| **Bar 21** | 0:56 – 0:59 | Sweeping cinematic crane shot descending through live oak branches toward MC standing on a rock promontory. | **"COUNTRY [💥]"** — Cut to 3 riders on horseback silhouetted on a ridge. |
| **Bar 22** | 0:59 – 1:02 | MC pours a splash of Texas bourbon onto dry limestone rock. | **"SAKE [💥]"** — Liquid sizzles against hot rock; smoke rises. |
| **Bar 23** | 1:02 – 1:05 | Slow tracking push toward a massive black 1,000-gallon steel offset smoker in the yard of Opie's BBQ. | **"BRISKET [💥]"** — Smoker lid swings wide; billowing aromatic post-oak smoke engulfs screen! |
| **Bar 24** | 1:05 – 1:07 | Macro top-down shot of a 14-inch Granton-edge slicing knife gliding through a 16-hour smoked brisket flat. | **"TAKES [💥]"** — Slices separate; glistening amber tallow juices squirt under knife pressure. |
| **Bar 25** | 1:07 – 1:10 | Low-angle ground-level shot of a massive Texas Longhorn steer with 7-foot horn spread standing in native bluestem grass. | **"BREEDS [💥]"** — Steer snorts hot breath into the morning air. |
| **Bar 26** | 1:10 – 1:13 | MC resting shoulder against a weathered Aermotor water windmill spinning lazy circles in the breeze. | **"RARE [💥]"** — MC tips the brim of his Stetson up toward camera with a cold stare. |
| **Bar 27** | 1:13 – 1:16 | 360-degree orbital drone shot revolving around the MC standing at the highest point of Spicewood overlooking the Colorado basin. | **"HERE [💥]"** — Sudden snap-zoom to MC's eyes. |
| **Bar 28** | 1:16 – 1:19 | Medium shot: MC points right index finger to his temple with an outlaw smirk. | **"THERE! [💥]"** — Giant kinetic stencil stamps screen: **`78669`**! |

---

#### [Verse 2: Bars 29–44] ⏱️ 1:19 – 2:04 (16 Bars / 45.2s)

##### 🔹 Part A: Post-Oak Pitmaster & Pace Bend (Bars 29–36 / 1:19 – 1:42)
...
##### 🔹 Part B: ⚡ 8-Bar Mega Double-Time Speed Burst (Bars 37–44 / 1:42 – 2:04)
*Editing Rhythm: RADICAL ACCELERATION! 16th-note rapid-fire lyric delivery. Hyper-kinetic cuts, dynamic ramping (1.25x to 2.0x), whip-pans, and strobing kinetic typography overlays!*
...
* **Bar 38 (1:45 – 1:48) | Shot 2.10 [Iron Wolf Howl]:**
  ...
  * **Typography:** `(Iron-Wolf-is-howlin'-I'm-a)` flashes in 16th notes; **`ENGINES GROWLIN'`** vibrates with a 3-pixel screen shake!

* **Bar 39 (1:48 – 1:50) | Shot 2.11 [River Drift]:**
  * **Visual:** Truck executing a power slide around a caliche gravel river bend, flinging a massive rooster tail of white gravel and limestone dust.
  * **Typography:** `(Whippin'-round-the-river-I'm-a)` -> **`PULL UP WITH THE THOUSANDS`** expands from screen center!

* **Bar 40 (1:50 – 1:53) | Shot 2.12 [Valley Echo]:**
  * **Visual:** High-speed drone dive straight down the Pedernales valley corridor, tracking the river as the sun hits the horizon.
  * **Typography:** `(Pedernales-valley-I'm-a)` -> **`MAKE THE WHOLE TOWN LOUD AND...`** text fills the entire screen width!

* **Bar 41 (1:53 – 1:56) | Shot 2.13 [The Gold Rush]:**
  * **Visual:** Green Highway 71 mile marker sign. Camera whips to MC clutching a fistful of vintage Texas banknotes and cassette reels.
  * **Typography:** `(Spicewood-in-my-pocket-I'm-a)` -> **`MAKE ANOTHER MILLION`** transforms into embossed gold foil letters!

* **Bar 42 (1:56 – 1:59) | Shot 2.14 [📢 Hats on in the Pavilion!]:**
  * **Visual:** 💥 **INSTANT TEMPO BRAKE!** Wide tableau shot of a packed outdoor cedar dancehall pavilion. Over 50 locals, dancers, and ranchers in cowboy hats instantly freeze and tip their Stetsons in perfect unison right as the booming baritone voice roars!
  * **Typography:** Giant centered neon headline: **`📢 HATS ON IN THE PAVILION!`** in electric neon sign styling with humming tube audio FX.

* **Bar 43 (1:59 – 2:01) | Shot 2.15 [The High Roll]:**
  * **Visual:** Rapid-fire 3-frame strobe cuts: Vinyl record spinning -> Smoker firebox roaring -> River rope swing plunging -> MC grinning.
  * **Typography:** `(Stackin'-up-the-paper-is-a)` -> **`HELL OF A FEELIN'`** pulses in radiant crimson!

* **Bar 44 (2:01 – 2:04) | Shot 2.16 [One in a Trillion Climax]:**
  * **Visual:** MC raises his fist straight into the blazing center of the setting Texas sun. Anamorphic horizontal lens flare strikes the lens in brilliant streak gold!
  * **Typography:** `(Spittin'-pure-gold-baby-I'm-a)` -> **`ONE IN A TRILLION!`** explodes into shimmering gold dust particles!

---

#### [Hook 2: Bars 45–52] ⏱️ 2:04 – 2:27 (8 Bars / 22.6s)
*Tone: Hometown Community Celebration. Wide, warm, golden hour glow. Everyone singing together.*

* **Bars 45–48 (2:04 – 2:15):**
  * Tracking drone skimming over long wooden picnic tables laden with brisket, peach cobbler, and iced Shiner Bock.
  * Pitmasters and locals raising glasses directly to the camera; children jumping into the shallow river shallows in slow motion.
* **Bars 49–52 (2:15 – 2:27):**
  * Low-angle group shot on the truck tailgate: MC flanked by local musicians, ranchers, and friends singing the chorus line in unison.
  * On Bar 52 (2:24) *"Because we're not all... THERE!"*, entire crowd belts out the line, pointing fingers to the sky as twilight settles over the hills.

---

### 📍 ACT III: GOLDEN HOUR, OUTLAW LEGACY & THE HEAVY DROP

#### [Verse 3: Bars 53–68] ⏱️ 2:27 – 3:12 (16 Bars / 45.2s)

##### 🔹 Part A: Golden Hour Storyteller (Bars 53–60 / 2:27 – 2:50)
*Cinematography: 85mm portrait telephoto with razor-thin depth of field. Deep amber, honey, and violet sky tones.*

* **Bar 53 (2:27 – 2:30) | Shot 3.1 [Scarlet Sunset]:**
  * Giant red Texas sun sinking into the cedar horizon; purple and amber smoke haze hanging low over the canyons.
  * *Lyric: "Scarlet sunset, CEDAR HAZE"*

* **Bar 54 (2:30 – 2:33) | Shot 3.2 [Dusk Sky]:**
  * Twilight sky transitioning from burnt peach to deep indigo. First bright evening stars blinking into view.
  * *Lyric: "Constellation, GOLDEN MAZE"*

* **Bar 55 (2:33 – 2:36) | Shot 3.3 [The Cicada Macro]:**
  * Macro shot of a cicada clinging to rough live oak bark, translucent wings backlit by the dying sun like spun glass.
  * *Lyric: "Cicadas hummin', SUN RAYS"*

* **Bar 56 (2:36 – 2:38) | Shot 3.4 [The Porch Watch]:**
  * Weathered boots propped up on a cedar porch railing. MC pulls an antique brass pocket watch from his vest pocket.
  * *Lyric: "Outlaw lifestyle, COUNT'n THE DAYS"*

* **Bar 57 (2:38 – 2:41) | Shot 3.5 [The Porch Swing]:**
  * Wooden two-seater porch swing gently creaking back and forth in slow motion. A worn acoustic guitar leans against the siding.
  * *Lyric: "Porch swing rockin', OUTLAW WAYS"*

* **Bar 58 (2:41 – 2:44) | Shot 3.6 [Vinyl in the Breeze]:**
  * A portable vintage turntable on the porch wicker table, needle riding the vinyl grooves as dry oak leaves drift by.
  * *Lyric: "Timeless rhythm, WILL AMAZE"*

* **Bar 59 (2:44 – 2:47) | Shot 3.7 [Willie's Trigger]:**
  * Slow push on a silhouette of an outlaw picking acoustic arpeggios on a battered nylon guitar inside Luck, Texas chapel.
  * *Lyric: "Willie picks Trigger, Guns ABLAZE"*

* **Bar 60 (2:47 – 2:50) | Shot 3.8 [Reel-to-Reel Tape]:**
  * Vintage 1/4-inch Studer reel-to-reel tape deck spinning in the warm light of vacuum tubes.
  * *Lyric: "Spin the vintage reel, LEt the record PLAY"*

---

##### 🔹 Part B: Syncopated Triplet Swing & 786 Climax (Bars 61–68 / 2:50 – 3:12)
*Editing Rhythm: 3-3-2 rolling triplet cadence (MF DOOM / Joey Bada$$ jazz flow). Lateral dolly glides on beats [1]-[2]-[3]!*

* **Bar 61 (2:50 – 2:53) | Shot 3.9 [Single Bulb Swing]:**
  * A bare incandescent bulb swings on an exposed wire over an antique slate pool table in an old Spicewood roadhouse.
  * *Lyric: "(Seven-eight-six in the) SPOTLIGHT FLICK"*

* **Bar 62 (2:53 – 2:56) | Shot 3.10 [Bluebonnet Ridge]:**
  * Low tracking shot skimming right above blooming Texas bluebonnets and silver-leaf nightshade along a limestone ledge.
  * *Lyric: "(Bluebonnet fields where the) CEDAR THICK"*

* **Bar 63 (2:56 – 2:58) | Shot 3.11 [Sleight of Hand]:**
  * MC flips a silver 1921 Morgan dollar coin across his knuckles without looking, slipping it into his jacket pocket.
  * *Lyric: "(Low-key lyricist) MAGIC TRICK"*

* **Bar 64 (2:58 – 3:01) | Shot 3.12 [Metronome Tick]:**
  * Antique pendulum clock on a cedar mantelpiece, pendulum swinging in hard sync to the snare cracks: *Ti-ti-tok TICK!*
  * *Lyric: "(Every single rhyme like a) Ti-ti-tok TICK"*

* **Bar 65 (3:01 – 3:04) | Shot 3.13 [Toast to the Area Code]:**
  * Mason jars of amber whiskey raised high toward the camera in a warm honky-tonk tavern.
  * *Lyric: "Raise that glass, SEVEN-EIGHT-SIX"*

* **Bar 66 (3:04 – 3:07) | Shot 3.14 [Neon Jukebox]:**
  * Vintage Wurlitzer jukebox glowing magenta and gold in the corner of a dark wooden tavern.
  * *Lyric: "Outlaw music, MIDNIGHT MIX"*

* **Bar 67 (3:07 – 3:10) | Shot 3.15 [The Hay Ride]:**
  * An old John Deere tractor pulling a wooden hay wagon packed with friends, laughing under string lights strung between live oaks.
  * *Lyric: "A bumpy hay ride, NOTHIN' TO FIX"*

* **Bar 68 (3:10 – 3:12) | Shot 3.16 [Hometown Legend]:**
  * MC standing alone atop the tailgate, silhouette framed by the purple Hill Country twilight sky, microphone held high!
  * *Lyric: "I'ma Spicewood legend, SEVEN-EIGHT-SIX!"*

---

#### [Bridge / Break: Bars 69–71] ⏱️ 3:12 – 3:21 (3 Bars / 8.5s)
*Sound Design: At Bar 71 / 3:18, drums abruptly CUT OUT! Only the echoing Rhodes piano chords and ambient night cicadas remain. Snare roll builds into the drop.*

* **Bar 69 (3:12 – 3:15) | Shot 3.17 [Extreme Porch Close-Up]:**
  * Extreme close-up on the weathered, sun-lined face of an elder Texas rancher sitting on the porch steps, squinting out into the dusk.
  * *Dialogue: "I tell you what..."*

* **Bar 70 (3:15 – 3:18) | Shot 3.18 [The Grin]:**
  * Medium shot: MC steps off the porch onto the white gravel, pulling his jacket collar up and grinning back at the elder.
  * *Dialogue: "Dang old city folk slippin' in..."*

* **Bar 71 (3:18 – 3:21) | Shot 3.19 [🛑 The Pre-Drop Tension]:**
  * **3:18:** Complete silence of the drum kit! Rhodes chords shimmer.
  * **3:19:** Two high-beam truck headlights flick on directly behind the MC, blinding the camera lens with intense white and amber volumetric flare.
  * **3:20:** Fast accelerating military snare roll builds in volume:
  * *Dialogue: "We'll give 'em a run! ... HIT 'EM!"* 💥

---

#### [Final Hook: Bars 72–79] ⏱️ 3:21 – 3:44 (8 Bars / 22.6s)
*Sound: 💥 **THE HEAVY DROP AT MEASURE 72 (3:21)!** Full explosive boom-bap kick and crackling snare slam back in with double-tracked vocals and sub-bass impact!*

* **Bar 72 (3:21) [THE DROP]:**
  * Screen bursts from headlight whiteout into a massive bonfire explosion of orange sparks shooting 30 feet into the night sky!
  * Sub-bass rumble triggers an anamorphic lens shake.
  * MC is in mid-rhyme, performing with maximum adrenaline surrounded by blazing bonfires and cheering locals!
* **Bars 73–78 (3:24 – 3:41):**
  * Rapid, triumphant montage intercutting the grandest moments of the video:
    * Swimmer plunging into Krause Springs waterfall spray in reverse!
    * Pace Bend cliff jumper silhouetted against glowing orange sunset!
    * Slicing the juiciest brisket flat at Opie's with smoke billowing!
    * Vintage Ford truck doing a controlled burnout on blacktop leaving two parallel rubber lines!
    * Fiddler in Luck, Texas tearing into an outlaw lick with bow hair fraying!
* **Bar 79 (3:41 – 3:44):**
  * Entire cast stands on the limestone bluff overlooking Lake Travis, raising their glasses and hats to the camera:
  * *Lyric: "Because we're not all THERE! (Spicewood, Texas, can't compare!)"*

---

#### [Outro: Bars 80–102] ⏱️ 3:44 – 4:48 (23 Bars / 64.9s)
*Sound: Drums gently filter out with a warm low-pass sweep at Bar 80 (3:44). Rhodes piano loop rolls softly as live crickets and crackling vinyl dust fill the stereo field.*

* **Bars 80–88 (3:44 – 4:07) | Shot 4.1 [Tailgate Jam]:**
  * MC sits casually on the lowered truck tailgate with his boots dangling. He holds Trigger homage guitar across his lap, smiling and nodding as he talks to the audio engineer off-camera:
  * *"Yeah... shout out to Krause Springs. Shout out to Luck, Texas. Willie Nelson. Pedernales River..."*
* **Bars 89–96 (4:07 – 4:30) | Shot 4.2 [Ascending Drone Crane]:**
  * Drone camera slowly pulls back and ascends high above the truck parked on the hill. The glowing bonfire becomes a warm amber speck among the dark silhouette of the Hill Country ridges.
  * Stars fill the dark Texas night sky above.
  * *"We're all out here because we're all not there. Turn the monitors down... let the crickets sing."*
* **Bars 97–102 (4:30 – 4:48) | Shot 4.3 [Fade to Vinyl Dust]:**
  * Final lingering shot of a small wooden roadside sign beside Highway 71 lit by a single warm lantern:
  * **`SPICEWOOD - 78669`**
  * *"Peace."*
  * Lantern slowly clicks off. Screen fades to rich velvet black as the vinyl turntable needle reaches the runout groove and softly clicks... clicks... clicks... silence.
...
### 🎬 Scene-by-Scene Prompt Catalog

#### Scene 1: Highway 71 Golden Hour Cruise (Intro / Bars 1–4)
* **Midjourney v6.1 Prompt:**
  ```text
  Cinematic 35mm film still, low-angle tracking shot of a weathered vintage 1978 two-tone copper and cream Ford F-150 pickup truck driving west on two-lane Texas Highway 71 at golden hour, rolling limestone hills of Spicewood Texas in background, long lens compression, warm golden sun flares, heat mirage shimmering off asphalt, Kodak Portra 400 film grain, anamorphic 2.39:1 aspect ratio --ar 16:9 --style raw --v 6.1
  ```
* **Runway Gen-3 Alpha / Kling Video Prompt:**
  ```text
  Low-angle cinematic tracking shot moving smoothly beside a vintage 1978 two-tone Ford pickup truck driving down a sunlit Texas hill country highway. The driver's arm rests out the open window, hand riding the breeze. Warm golden hour sunlight flares through the windshield, casting long shadows across the rolling cedar hills. Organic 35mm film grain, realistic vehicle suspension physics, 24fps.
  ```

#### Scene 2: Krause Springs Waterfall & Grotto (Verse 1 / Bars 5–8)
* **Midjourney v6.1 Prompt:**
  ```text
  Cinematic 35mm film photograph, lush natural spring waterfall cascading over tiered limestone rocks covered in maidenhair ferns into a crystal-clear turquoise swimming hole at Krause Springs Spicewood Texas, towering 500-year-old bald cypress trees with massive roots, sunbeams piercing the canopy, mist rising from emerald water, 1990s hip hop music video aesthetic, Kodak Vision3 500T --ar 16:9 --style raw --v 6.1
  ```
* **Runway Gen-3 Alpha / Kling Video Prompt:**
  ```text
  FPV drone gliding down a natural limestone canyon, skimming low above emerald freshwater rapids cascading over smooth rock ledges. Swirling water mist catches brilliant afternoon sunbeams, with towering cypress trees draped in moss framing the riverbanks. High shutter speed capturing individual water droplets, fluid motion, 35mm film texture, 24fps.
  ```

#### Scene 3: Willie Nelson's Trigger Guitar Homage (Verse 1 / Bar 19 & Verse 3 / Bar 59)
* **Midjourney v6.1 Prompt:**
  ```text
  Cinematic macro close-up of a legendary vintage Martin N-20 classical nylon-string acoustic guitar, worn natural spruce top with a large pick-worn hole beside the soundhole, lacquer checking, wood grain patina, etched autographs of country legends carved into the wood, resting on a weathered cedar porch swing, golden sunset side-lighting, shallow depth of field, 35mm film still --ar 16:9 --style raw --v 6.1
  ```
* **Runway Gen-3 Alpha / Kling Video Prompt:**
  ```text
  Slow macro camera dolly sliding horizontally across the weathered spruce soundboard of a heavily played vintage nylon-string acoustic guitar. Sunlight grazes the worn pick grooves and carved signatures in the wood. Shallow depth of field, gentle lens flare, warm vintage film halation.
  ```

#### Scene 4: The 1,000-Gallon Offset Smoker at Opie's (Hook 1 / Bars 23–24 & Verse 2 / Bars 29–31)
* **Midjourney v6.1 Prompt:**
  ```text
  Cinematic 35mm film still, Texas pitmaster lifting the heavy steel counterweight door of a massive 1,000-gallon black iron offset barbecue smoker, thick billows of white aromatic post-oak smoke rolling out into the golden evening air, dozens of glistening smoked briskets with dark mahogany bark resting on the expanded steel grates, glowing embers in firebox, authentic Spicewood Texas smokehouse, Kodak 5219 film --ar 16:9 --style raw --v 6.1
  ```
* **Runway Gen-3 Alpha / Kling Video Prompt:**
  ```text
  Medium slow-motion shot of a pitmaster in a heavy canvas apron opening a giant black iron barbecue smoker door. A dense cloud of white post-oak wood smoke bursts outward, catching the warm evening sunlight. Inside, rows of glistening briskets with deep black bark steam on the grates. Volumetric smoke physics, cinematic lighting, 24fps.
  ```

#### Scene 5: Pace Bend Limestone Cliff Jump (Verse 2 / Bars 33–34)
* **Midjourney v6.1 Prompt:**
  ```text
  Cinematic action photograph, 35mm film, wide low-angle shot of an adventurous young Texan leaping off a 40-foot pale limestone cliff into the deep cobalt blue waters of Lake Travis at Pace Bend Park, golden hour sun flaring behind the cliff, cedar trees dotting the cliff edge, water ripples far below, suspended mid-air in freefall, Kodak Ektachrome vivid film --ar 16:9 --style raw --v 6.1
  ```
* **Runway Gen-3 Alpha / Kling Video Prompt:**
  ```text
  Slow-motion 60fps tracking shot following a cliff jumper leaping off a high limestone bluff into deep cobalt lake water. The camera tilts down rapidly as the jumper plunges toward the shimmering water surface, creating a massive emerald splash. Sunlight glints off airborne droplets, natural gravity physics, 35mm film stock.
  ```
...
* **Midjourney v6.1 Prompt:**
  ```text
  Cinematic interior 35mm film photograph, moody vintage Spicewood Texas roadhouse tavern at twilight, a single bare Edison bulb swinging slowly on an exposed cloth wire above a green felt pool table, casting moving golden shadows across rustic cedar-clad walls, neon beer signs humming in background, mason jars of bourbon, smoky atmospheric haze --ar 16:9 --style raw --v 6.1
  ```
* **Runway Gen-3 Alpha / Kling Video Prompt:**
  ```text
  Atmospheric slow tracking shot inside a rustic Texas tavern. A single incandescent bulb gently sways overhead, casting moving pools of warm light and long shadows across an old pool table and wooden bar. Neon beer signs glow softly in the smoky air. Smooth camera glide, cinematic shadow play.
  ```
...
* **Runway Gen-3 Alpha / Kling Video Prompt:**
  ```text
  Low-angle camera starts in blinding white truck headlights, then whip-pans as a massive outdoor bonfire erupts with thousands of glowing amber sparks swirling into the dark starry sky. A crowd of locals on truck tailgates cheers with raised drinks while the performer raps with intense energy. Dynamic camera shake on the heavy drum drop, cinematic night lighting.
  ```

---

## 💥 4. MOTION GRAPHICS & KINETIC TYPOGRAPHY SPECIFICATION

Following VoiceFi's **Universal Reel Production Architecture** (Tier 4: Headless Chrome Kinetic Subtitles with Faster-Whisper alignment and stationary zero-jitter geometry):

### 🔤 Typography & Font Hierarchy
| Role | Typeface | Specs | Color & Styling |
| :--- | :--- | :--- | :--- |
| **Outlaw Headlines / Title Cards** | **Cooper Black** or **Cheltenham Bold** | 72–96px, Upper & Title Case | Cream `#F5EBE0` with heavy 4px burnt orange drop shadow `#C25E1A` and subtle CRT scanlines. |
| **Snare Accent Punchwords [4 💥]** | **Futura Bold Condensed** or **Impact** | 80–110px, All-Caps | High-visibility Golden Amber `#FFBF00` with 1-frame white inversion bloom on hit. |
| **Double-Time Rapid Subtitles (Bars 37–44)** | **Neue Haas Grotesk 800** | 48–56px, Center-Locked | White `#FFFFFF` with charcoal stroke `#1A1A1A`. Fixed baseline at `bottom: 180px` (zero vertical jumping). |
| **90s VHS / Camcorder Timecode HUD** | **VCR OSD Mono** | 24–32px, Monospace | Phosphor Green `#39FF14` or Amber `#FFB000`, pulsing recording dot `REC [●]`. |

---

### ⏱️ Beat-Synced Motion Cues & Animation Triggers

```text
Measure / Bar  │ Audio Event                   │ Visual Motion Graphic / FX Trigger
───────────────┼───────────────────────────────┼─────────────────────────────────────────────────────────────
...
Bar 20 [0:56]  │ "HIGHEST STAKES!" [4 💥]      │ Snap-zoom (1.15x punch); quick white flash on snare.
Bar 21–28      │ Hook 1 Snare Cracks [4 💥]    │ On each 4th-beat snare, target word (COUNTRY, BRISKET, etc.)
               │                               │ slams down in 96px bold with 0.15s radial shockwave ring.
Bar 28 [1:18]  │ "7-8-6-6-9"                   │ Vintage Highway 71 green metal route shield graphic
               │                               │ stamps lower center with authentic metal clatter sound.
Bar 37–44      │ ⚡ Mega Double-Time Burst      │ Karaoke-style glowing yellow syllable fill tracked at 16th
               │                               │ notes; dynamic frame rate ramping between 24fps and 12fps.
Bar 42 [1:57]  │ "📢 Hats on IN THE PAVILION!" │ Full-screen graphic banner: "HATS ON IN THE PAVILION"
               │                               │ pulses in electric neon tubing; all background motion freezes!
Bar 68 [3:10]  │ "SEVEN-EIGHT-SIX!"            │ Giant stencil numbers "7 8 6" burn into screen in amber fire.
Bar 71 [3:18]  │ Drums cut out (Break)         │ Screen desaturates 30%; subtle CRT film roll jitter.
Bar 71 [3:20]  │ "HIT 'EM!" Snare roll         │ Rapid 12-frame white strobe building to blinding flash!
Bar 72 [3:21]  │ 💥 HEAVY BEAT DROP            │ Screen EXPLODES with bonfire embers; sub-bass camera rumble;
               │                               │ gold text "OUTLAW COUNTRY" expands past screen borders!
Bar 80 [3:44]  │ Outro Piano Fade              │ Subtitles transition into lower-third cursive typewriter font.
Bar 102 [4:48] │ Final Needle Lift             │ VHS tape rewinds with horizontal blue tracking noise; fade black.
```

---

## 🛠️ 5. COMPOSITION & RENDER PIPELINE RECIPES

### 📦 FFmpeg Command for Master 9:16 Social Reel with Beat-Synced Overlays
```bash
# High-fidelity 9:16 Vertical Render (1080x1920) with ProRes / H.264 muxing:
ffmpeg -y \
  -ss 00:01:42 -to 00:02:04 \
  -i "assets/spicewood_texas_4k_master.mov" \
  -ss 00:01:42 -to 00:02:04 \
  -i "/Users/jaketrigg/Projects/VoiceFi/Shinra B - SOCIETY (90s Boom Bap Beat) [85 BPM].mp3" \
  -filter_complex \
  "[0:v]scale=1080:1920:force_original_aspect_ratio=increase,crop=1080:1920,eq=contrast=1.08:saturation=1.12[bg]; \
   [bg]drawtext=fontfile='/System/Library/Fonts/Supplemental/Futura.ttc':text='78669':fontsize=120:fontcolor=white@0.9:x=(w-text_w)/2:y=240:enable='between(t,15,22)'[v]" \
  -map "[v]" -map 1:a:0 \
  -c:v libx264 -preset slow -crf 18 -pix_fmt yuv420p \
  -c:a aac -b:a 320k -ar 48000 \
  "dist/spicewood_texas_mega_speed_burst_reel_9_16.mp4"
```

---

## 📌 6. SUMMARY & NEXT STEPS
1. **Asset Generation:** Run the Midjourney prompts to establish character, lighting, and environment reference keys.
2. **Video Generation:** Ingest keyframes into Runway Gen-3 Alpha or Kling AI with the prompt formulas in Section 3.
3. **Audio-Video Alignment:** Utilize VoiceFi's `build_gapless_timeline()` to lock subtitle timing directly to the 85.0 BPM beat grid.
4. **Publishing:** Export 9:16 reels directly to `http://localhost:5141/downloads` for immediate mobile camera-roll sharing.
