...
def main():
    ...
    parser.add_argument("--key", default=os.getenv("POSTHOG_PERSONAL_API_KEY", ""), help="PostHog Personal API Key (starts with phx_)")
    parser.add_argument("--project-id", default=os.getenv("POSTHOG_PROJECT_ID", "350469"), help="PostHog Project / Team ID")
    parser.add_argument("--dashboard-id", default="2066598", help="Existing Dashboard ID to attach to")
    ...
    insights = [
        {
            ...
            "query": {
                ...
                "source": {
                    "kind": "FunnelsQuery",
                    "series": [
                        {"kind": "EventsNode", "name": "1. vifi.sh Downloaded", "event": "install_script_downloaded"},
                        {"kind": "EventsNode", "name": "2. Installer Started", "event": "install_started"},
                        {"kind": "EventsNode", "name": "3. Python Bootstrapped", "event": "python_bootstrapped"},
                        {"kind": "EventsNode", "name": "4. Install Completed", "event": "install_completed"},
                        {"kind": "EventsNode", "name": "5. First Spoken Turn ⭐", "event": "first_spoken_turn"}
                    ],
        ...
        },
        {
            ...
            "query": {
                ...
                "source": {
                    "kind": "TrendsQuery",
                    "series": [
                        {"kind": "EventsNode", "math": "total", "name": "MCP Tool Invocations", "event": "$mcp_tool_call"}
                    ],
                    "dateRange": {"date_from": "-30d"},
                    "breakdownFilter": {
                        "breakdown": "tool_name",
        ...
        },
        {
            ...
            "query": {
                ...
                "source": {
                    "kind": "TrendsQuery",
                    "series": [
                        {"kind": "EventsNode", "math": "total", "name": "Spoken Turns Completed", "event": "voice_turn_completed"},
                        {"kind": "EventsNode", "math": "total", "name": "Barge-In Interruptions", "event": "barge_in_triggered"}
                    ],
                    "dateRange": {"date_from": "-30d"},
                    "trendsFilter": {
        ...
        },
        {
            ...
            "query": {
                ...
                "source": {
                    "kind": "TrendsQuery",
                    "series": [
                        {"kind": "EventsNode", "math": "total", "name": "WebMCP Pageviews", "event": "$pageview", "properties": [
                            {"key": "$current_url", "value": "webmcp", "operator": "icontains", "type": "event"}
                        ]},
                        {"kind": "EventsNode", "math": "total", "name": "Browser Voice Auditions", "event": "voicefi_audition_played"}
                    ],
                    "dateRange": {"date_from": "-30d"},
                    "trendsFilter": {
                        "display": "ActionsLineGraph"
