...
work_dir = '/tmp/spicewood_act3_work'
os.makedirs(work_dir, exist_ok=True)
output_mp4 = '/Users/jaketrigg/Desktop/spicewood_act3.mp4'
...
# Curated 43-shot measure-locked sequence (1 to 2 musical bars per cut, zero looping)
shots = [
    # Section 1: Porch Whittling, Tube Glow & Wisdom (150.62 - 161.56s)
    ('3.01',  150.62, 154.50, 'spicewood_act3_downloaded_scenes/Scene_01_3.01_Sunset_Canyon.mp4', 0.0),
    ('3.02',  154.50, 157.00, 'spicewood_act3_downloaded_scenes/Scene_04_3.04_Porch_Whittling.mp4', 0.0),
    ('3.03',  157.00, 159.34, 'spicewood_act3_raw/Tube_amplifier_glowing_on_shelf_202609031636.mp4', 0.0),
    ('3.04',  159.34, 161.56, 'spicewood_act3_downloaded_scenes/Scene_03_3.03_Cicada_Macro.mp4', 0.0),

    # Section 2: Willie's Trigger & Vintage Reel (161.56 - 170.64s)
    ('3.05a', 161.56, 162.54, 'spicewood_act3_downloaded_scenes/Scene_06_3.07a_Trigger_Guitar_Picking.mp4', 0.0),
    ('3.05b', 162.54, 163.40, 'spicewood_act3_downloaded_scenes/Scene_07_3.07b_Trigger_Guitar_Body.mp4', 0.0),
    ('3.05c', 163.40, 164.38, 'spicewood_act3_downloaded_scenes/Scene_08_3.07c_Trigger_Guitar_Neck.mp4', 0.0),
    ('3.06',  164.38, 167.08, 'spicewood_act3_downloaded_scenes/Scene_09_3.08_Reel_To_Reel_Tape.mp4', 0.0),
    ('3.07',  167.08, 170.64, 'spicewood_act3_downloaded_scenes/Scene_10_3.10_Bluebonnet_Ridge.mp4', 0.0),

    # Section 3: Speed Verse / Rapid-Fire 786 (170.64 - 192.06s)
    ('3.08',  170.64, 174.30, 'spicewood_hero_selects/Act_3/Shot_3.09_Roadhouse_Pool_Table.mp4', 0.0),
    ('3.09',  174.30, 176.88, 'spicewood_act3_downloaded_scenes/Scene_12_3.11_Turquoise_Zippo_Snap.mp4', 0.0),
    ('3.10',  176.88, 178.56, 'spicewood_act3_downloaded_scenes/Scene_11_3.12_Grandfather_Clock.mp4', 0.0),
    ('3.11',  178.56, 180.98, 'spicewood_act3_downloaded_scenes/Scene_13_3.13_Tavern_Bourbon_Toast.mp4', 0.0),
    ('3.12a', 180.98, 182.50, 'spicewood_act3_downloaded_scenes/Scene_14_3.14a_Neon_Jukebox_Wide.mp4', 0.0),
    ('3.12b', 182.50, 183.84, 'spicewood_act3_downloaded_scenes/Scene_15_3.14b_Neon_Jukebox_Turntable.mp4', 0.0),
    ('3.13',  183.84, 186.82, 'spicewood_act3_downloaded_scenes/Scene_16_3.15_Tractor_Hayride.mp4', 0.0),
    ('3.14a', 186.82, 188.60, 'spicewood_act3_downloaded_scenes/Scene_17_3.16a_Outlaw_Tailgate_Hero.mp4', 0.0),
    ('3.14b', 188.60, 190.40, 'spicewood_act3_downloaded_scenes/Scene_18_3.16b_Outlaw_Tailgate_Medium.mp4', 0.0),
    ('3.14c', 190.40, 192.06, 'spicewood_hero_selects/Act_3/Shot_3.16_Outlaw_Tailgate_Dusk.mp4', 0.0),

    # Section 4: The Turnaround Buildup (192.06 - 201.12s)
    ('3.15',  192.06, 196.00, 'spicewood_act3_downloaded_scenes/Scene_20_3.17_Elder_Rancher_Speaking.mp4', 0.0),
    ('3.16',  196.00, 199.50, 'spicewood_act3_downloaded_scenes/Scene_21_3.18_Outlaw_Gravel_Walk.mp4', 0.0),
    ('3.17',  199.50, 201.12, 'spicewood_act3_downloaded_scenes/Scene_22_3.19_Truck_Headlights_Flare.mp4', 0.0),

    # Section 5: Climax Hook 3 / Grand Outlaw Anthem (201.12 - 229.41s)
    ('3.18',  201.12, 203.95, 'spicewood_act3_raw/Campfire_erupts_with_roaring_flames_202609031636.mp4', 0.0),
    ('3.19',  203.95, 206.77, 'spicewood_act3_raw/Bonfire_exploding_into_starry_night_202609031636.mp4', 0.0),
    ('3.20',  206.77, 209.60, 'spicewood_act2_raw/Act_II:_Outlaw_Anthem_&_202609031546_2.mp4', 0.50),
    ('3.21',  209.60, 212.42, 'spicewood_act3_raw/Barbecue_smoke_yard_at_sunset_202609031636.mp4', 0.0),
    ('3.22',  212.42, 215.25, 'spicewood_act3_raw/Horseback_riders_trotting_on_ridge_202609031636.mp4', 0.0),
    ('3.23',  215.25, 218.07, 'spicewood_act3_raw/Texas_Longhorn_steer_standing_in…_202609031635.mp4', 0.0),
    ('3.24',  218.07, 220.90, 'spicewood_act3_raw/03_texas_armadillos_lawn.mp4', 1.0, 'crop'),
    ('3.25',  220.90, 223.72, 'spicewood_act3_raw/Truck_drifting_on_gravel_river_202609031636.mp4', 0.0),
    ('3.26',  223.72, 226.55, 'spicewood_act3_raw/Lake_Travis_panoramic_view_202609031636.mp4', 0.0),
    ('3.27',  226.55, 229.41, 'spicewood_act3_raw/Limestone_campfire_erupts_with_f…_202609031636.mp4', 0.0),

    # Section 6: Authentic Hill Country Outro & Texas Goodnight (229.41 - 261.44s)
    ('3.28',  229.41, 233.00, 'spicewood_act3_outro/01_waterfall_ferns.mp4',    0.0, 'crop'),
    ('3.29',  233.00, 236.60, 'spicewood_act3_outro/02_spring_face_splash.mp4', 0.0, 'blur'),
    ('3.30',  236.60, 240.20, 'spicewood_act3_outro/03_texas_armadillos_lawn.mp4',     7.0, 'blur'),
    ('3.31',  240.20, 243.80, 'spicewood_act3_outro/04_cypress_spring_pool.mp4',     2.0, 'blur'),
    ('3.32',  243.80, 247.40, 'spicewood_act3_outro/05_bluebonnet_bluff.mp4',        1.5, 'blur'),
    ('3.33',  247.40, 251.00, 'spicewood_act3_outro/06_country_buggy_ride.mp4',      2.0, 'blur'),
    ('3.34',  251.00, 256.65, 'spicewood_act3_outro/08_dramatic_sky_lake_sunset.jpg', 0.0, 'kenburns'),
    ('3.35',  256.65, 261.44, 'spicewood_act3_outro/09_lake_twilight.mp4',           2.0, 'crop')
]

print(f'Slicing {len(shots)} Act 3 video shots...')
t0 = time.time()
seg_files = []
for idx, item in enumerate(shots, 1):
    ...
    mode = item[5] if len(item) > 5 else 'crop'
    ...
    if is_img:
        if '08_laptop_dock_sunset' in rel_path:
            vf = f'[0:v]scale=2560:1441,zoompan=z=\'min(zoom+0.0005,1.15)\':x=\'iw/2-(iw/zoom/2)\':y=\'ih/2-(ih/zoom/2)\':d={num_frames}:s=1280x720:fps=24,format=yuv420p,setsar=1[v]'
        else:
            vf = f'[0:v]scale=2560:1440,zoompan=z=\'min(zoom+0.0005,1.15)\':x=\'iw/2-(iw/zoom/2)\':y=\'ih/2-(ih/zoom/2)\':d={num_frames}:s=1280x720:fps=24,format=yuv420p,setsar=1[v]'
        cmd = [
            'ffmpeg', '-y',
            '-loop', '1',
            '-i', src_file,
        ...
        vf = '[0:v]split=2[fg][bg];[bg]scale=1280:720:force_original_aspect_ratio=increase,crop=1280:720,boxblur=25:5[bg];[fg]scale=-1:720[fg];[bg][fg]overlay=(W-w)/2:0,format=yuv420p,setsar=1,fps=24[v]'
        cmd = [
            'ffmpeg', '-y',
            '-ss', str(src_in),
            '-i', src_file,
        ...
        vf = '[0:v]scale=1280:720:force_original_aspect_ratio=increase,crop=1280:720,format=yuv420p,setsar=1,fps=24[v]'
        cmd = [
            'ffmpeg', '-y',
            '-ss', str(src_in),
            '-i', src_file,
...
base_video = os.path.join(work_dir, 'act3_base_video.mp4')
subprocess.run([
    'ffmpeg', '-y',
    '-f', 'concat', '-safe', '0',
    '-i', concat_list,
...
def create_comic_burst(text, bg='#FFE500', shadow='#D50000', stroke='#000000', text_c='#FFFFFF', shape='star', angle=-8, w=380, h=180, spikes=18):
    ...
    # Font
    font_size = 38 if len(text) <= 10 else 30
...
# Pre-render the 2 Act 3 comic hype bursts
hype_bursts = {
    # Laser / Pew Pew burst (Master 164.10s - 165.62s -> Local 13.48s - 15.00s)
    'pew_pew': {
        'start': 13.48,
        'end': 15.00,
        'pos': (800, 200),
        'img': create_comic_burst('pew pew', bg='#E040FB', shadow='#00E5FF', stroke='#000000', text_c='#FFFFFF', shape='shock', angle=-15, w=340, h=170)
    },
    # Grandfather clock verse & "like a t-t-tik tok tik" (Master 176.88s - 178.56s -> Local 26.26s - 27.94s)
    'tik_tok': {
        'start': 26.26,
        'end': 27.94,
        'pos': (740, 290),
        'img': create_comic_burst('t-t-tik tok tik', bg='#FFF59D', shadow='#FF6D00', stroke='#000000', text_c='#000000', shape='cloud', angle=7, w=460, h=190)
    }
}

# Lyric Karaoke Subtitle Events
lyrics_timeline = [
    ...
    # 3.05: 161.56 - 164.38 (Local 10.94 - 13.76) - Willie pickin' Trigger!
    {
    ...
    # 3.06: 164.38 - 167.08 (Local 13.76 - 16.46) - Spin vintage reel!
    {
    ...
    # 3.07: 167.08 - 170.64 (Local 16.46 - 20.02) - 786 spotlight flick bluebonnet!
    {
    ...
    # 3.08: 170.64 - 174.30 (Local 20.02 - 23.68) - feed sick, low-key lyricist!
    {
    ...
    # 3.09: 174.30 - 176.88 (Local 23.68 - 26.26) - magic trick every single rhyme!
    {
    ...
    # 3.10: 176.88 - 178.56 (Local 26.26 - 27.94) - like a t-t-tik tok tik!
    {
    ...
    # 3.11: 178.56 - 180.98 (Local 27.94 - 30.36) - Raise that glass 786!
    {
    ...
    # 3.12: 180.98 - 183.84 (Local 30.36 - 33.22) - outlaw music midnight mix!
    {
    ...
    # 3.13: 183.84 - 186.58 (Local 33.22 - 35.96) - bumpy hayride nothin' to fix!
    {
    ...
    # 3.14: 186.58 - 190.24 (Local 35.96 - 39.62) - Spicewood legend 786!
    {
    ...
    # 3.15: 192.06 - 196.00 (Local 41.44 - 45.38) - Boomhauer Meaning of Life Part 1
    {
    ...
    # 3.16: 196.00 - 199.50 (Local 45.38 - 48.88) - Boomhauer Meaning of Life Part 2
    {
    ...
    # 3.17: 199.50 - 201.12 (Local 48.88 - 50.50) - Boomhauer Meaning of Life Part 3
    {
    ...
    # 3.18: 201.12 - 203.52 (Local 50.50 - 52.90) - Hook 3 Drop!
    {
...
# Outro Master Credit Card Generator
def create_outro_card():
    scale = 2
    w, h = 720 * scale, 230 * scale
    card = Image.new('RGBA', (w, h), (0, 0, 0, 0))
    draw = ImageDraw.Draw(card)
    
    draw.rounded_rectangle([(0, 0), (w, h)], radius=12*scale, fill=(10, 10, 15, 215), outline=(245, 158, 11, 160), width=2*scale)
    
    f_title = ImageFont.truetype('/System/Library/Fonts/HelveticaNeue.ttc', 30 * scale, index=1)
    f_by = ImageFont.truetype('/System/Library/Fonts/HelveticaNeue.ttc', 20 * scale, index=0)
    f_credit = ImageFont.truetype('/System/Library/Fonts/HelveticaNeue.ttc', 17 * scale, index=0)
    
    cx = w // 2
    draw.text((cx, 34 * scale), 'SPICEWOOD OUTLAW', font=f_title, fill='#FFFFFF', anchor='mm')
    draw.text((cx, 72 * scale), 'by vifi', font=f_by, fill='#F59E0B', anchor='mm')
    
    draw.line([(cx - 200 * scale, 100 * scale), (cx + 200 * scale, 100 * scale)], fill='rgba(255, 255, 255, 60)', width=1*scale)
    
    draw.text((cx, 136 * scale), 'Instrumental Beat: "Society" by Shinra B', font=f_credit, fill='#F3F4F6', anchor='mm')
    draw.text((cx, 175 * scale), 'Vocal Production & AI Direction: VoiceFi Productions', font=f_credit, fill='#D1D5DB', anchor='mm')
...
time_points = {0.0, ACT_DUR, MTV_CHYRON_START, MTV_CHYRON_END, OUTRO_CARD_START, OUTRO_CARD_END}
...
print(f'Rendering {len(sorted_times)-1} overlay time slices with anti-sticky typography...')
for old_ovl in glob.glob(os.path.join(work_dir, 'ovl_*.png')):
    try:
        os.remove(old_ovl)
    except OSError:
        pass
...
for i in range(len(sorted_times) - 1):
    ...
    if active_phrase:
        ...
        for widx, w in enumerate(words):
            if widx == active_idx:
                ...
                color = (156, 163, 175, 210) # Clean subtle grey (upcoming before spoken)
    ...
    # Opening preroll disabled per user request
    # if MTV_CHYRON_START <= t_start < MTV_CHYRON_END:
    #     frame.alpha_composite(mtv_chyron_img, dest=(60, 500))

    if OUTRO_CARD_START <= t_start < OUTRO_CARD_END:
        dest_x = (1280 - outro_card_img.width) // 2
        dest_y = 190
...
print('Compositing Act 3 master with untouched 24-bit 44.1kHz audio, needle drop Foley & karaoke overlay...')
t1 = time.time()
...
# Non-destructive amix of vinyl needle drop Foley resampled to 44.1kHz
...
subprocess.run([
    'osascript', '-e',
    'tell application "QuickTime Player" to if it is running then close (every document whose name contains "spicewood_act3") saving no'
...
print(f'Rendered Act 3 successfully: {output_mp4} ({time.time()-t1:.1f}s)')
