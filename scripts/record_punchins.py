...
def main():
    ...
    t1 = record_take("a broadcaster voice", duration=2.5, filename="punchin_1_a_broadcaster_voice.wav")
    t2 = record_take("this broadcaster voice", duration=2.5, filename="punchin_2_this_broadcaster_voice.wav")
