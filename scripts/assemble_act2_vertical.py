...
work_dir = '/tmp/spicewood_act2_vertical_work'
os.makedirs(work_dir, exist_ok=True)
output_mp4 = '/Users/jaketrigg/Desktop/spicewood_act2_vertical_9_16.mp4'
...
# Curated 27-shot sequence adapted for 9:16 vertical (1080x1920)
shots = [
    # 2.01a: Hook 1 drops - Grand hero shot on limestone bluff
    ('2.01a', 55.56, 58.38, 'spicewood_act2_raw/Act_II:_Outlaw_Anthem_&_202609031546_16.mp4', 0.0, None, 'center'),
    # 2.01b: Three horseback riders on ridge against sky
    ('2.01b', 58.38, 61.21, 'spicewood_act2_raw/Act_II:_Outlaw_Anthem_&_202609031546_31.mp4', 0.0, None, 'ambient_blur'),
    # 2.02: Sharp butcher knife slicing tender smoked brisket flat
    ('2.02', 61.21, 64.03, 'spicewood_act2_raw/Act_II:_Outlaw_Anthem_&_202609031546_2.mp4', 0.0, None, 'center'),
    # 2.03: Dense oak smoke billowing from outdoor pit smoker
    ('2.03', 64.03, 66.85, 'spicewood_act2_raw/Act_II:_Outlaw_Anthem_&_202609031546_39.mp4', 0.0, None, 'center'),
    # 2.04: Texas Longhorn steer standing proud in pasture
    ('2.04', 66.85, 69.68, 'spicewood_act2_raw/Act_II:_Outlaw_Anthem_&_202609031546_19.mp4', 0.0, None, 'center'),
    # 2.05: Nine-Banded Texas Armadillo rooting in limestone dirt
    ('2.05', 69.68, 72.50, 'spicewood_act2_raw/wildlife/armadillo_rooting_limestone.mp4', 0.0, None, 'center'),
    # 2.06: Weathered rancher tipping Stetson by spinning windmill
    ('2.06', 72.50, 75.32, 'spicewood_act2_raw/Act_II:_Outlaw_Anthem_&_202609031546_6.mp4', 0.0, None, 'center'),
    # 2.08: Outlaw tapping temple near green SPICEWOOD sign
    ('2.08', 75.32, 76.98, 'spicewood_act2_raw/Act_II:_Outlaw_Anthem_&_202609031546_7.mp4', 2.25, None, 'center'),
    # 2.09: Outlaw strides forward through barbecue smoke yard
    ('2.09', 76.98, 79.80, 'spicewood_act2_raw/Act_II:_Outlaw_Anthem_&_202609031546_18.mp4', 0.0, None, 'center'),
    # 2.10: Full outdoor smoke yard at sunset with massive offset smokers
    ('2.10', 79.80, 82.63, 'spicewood_act2_raw/Act_II:_Outlaw_Anthem_&_202609031546_35.mp4', 0.0, None, 'ambient_blur'),
    # 2.11: Pitmaster adding split post-oak log to firebox
    ('2.11', 82.63, 85.45, 'spicewood_act2_raw/Act_II:_Outlaw_Anthem_&_202609031546_34.mp4', 0.0, 2.40, 'center'),
    # 2.12: Outlaw gripping vintage Shure 55SH microphone by barn
    ('2.12', 85.45, 89.04, 'spicewood_act2_raw/Act_II:_Outlaw_Anthem_&_202609031546_14.mp4', 0.0, None, 'center'),
    # 2.13: Outlaw standing on limestone bluff edge
    ('2.13', 89.04, 91.80, 'spicewood_act2_raw/Act_II:_Outlaw_Anthem_&_202609031546_37.mp4', 0.0, None, 'center'),
    # 2.14: Underwater shot of cliff diver landing into cobalt lake water
    ('2.14', 91.80, 94.60, 'spicewood_act3_raw/Cliff_diver_hitting_lake_surface_202609031636.mp4', 0.2, None, 'center'),
    # 2.15: Pitmaster stirring glowing red-hot coals with iron poker
    ('2.15', 94.60, 97.40, 'spicewood_act2_raw/Act_II:_Outlaw_Anthem_&_202609031546_15.mp4', 0.0, None, 'center'),
    # 2.16: Headlights flaring on truck in dusk
    ('2.16', 97.40, 100.08, 'spicewood_act2_raw/Act_II:_Outlaw_Anthem_&_202609031546_4.mp4', 0.0, None, 'center'),
    # 2.17: Bar 37 Speed burst - Black muscle car prowling cedar trail
    ('2.17', 100.08, 103.18, 'spicewood_act2_raw/Act_II:_Outlaw_Anthem_&_202609031546_24.mp4', 0.0, None, 'center'),
    # 2.18: Bar 38 - Iron Wolf neon sign with howling wolf
    ('2.18', 103.18, 106.00, 'spicewood_act2_raw/Act_II:_Outlaw_Anthem_&_202609031546_5.mp4', 0.0, None, 'center'),
    # 2.19: Bar 39 - Hero truck drift on river gravel
    ('2.19', 106.00, 108.86, 'spicewood_act2_raw/truck_power_slide_hero_2.19.mp4', 0.0, None, 'center'),
    # 2.20: Bar 40 - High-speed FPV drone skimming down river canyon
    ('2.20', 108.86, 111.52, 'spicewood_act2_raw/Act_II:_Outlaw_Anthem_&_202609031546_36.mp4', 0.0, None, 'ambient_blur'),
    # 2.21: Bar 41 - Hero cash fan on bluff with turquoise ring
    ('2.21', 111.52, 114.50, 'spicewood_act2_raw/outlaw_money_fan_hero_2.21.mp4', 0.0, None, 'center'),
    # 2.22: Bar 42 - Open-air wooden dancehall pavilion with two-stepping crowd
    ('2.22', 114.50, 116.98, 'spicewood_act2_raw/Act_II:_Outlaw_Anthem_&_202609031546_21.mp4', 0.0, None, 'center'),
    # 2.23: Bar 43 - Outlaw on bluff overlooking river in golden sunset
    ('2.23', 116.98, 119.76, 'spicewood_act2_raw/Act_II:_Outlaw_Anthem_&_202609031546_11.mp4', 0.0, None, 'center'),
    # 2.24: Bar 44 - Outlaw looking into radiant setting Texas sun with fist raised
    ('2.24', 119.76, 123.20, 'spicewood_act2_raw/Act_II:_Outlaw_Anthem_&_202609031546_3.mp4', 0.0, None, 'center'),
    # 2.25a: Hook 2 - Community feast picnic table under oaks
    ('2.25a', 123.20, 126.00, 'spicewood_act2_raw/Act_II:_Outlaw_Anthem_&_202609031546_33.mp4', 0.0, None, 'center'),
    # 2.25b: Texas Whitetail Buck stepping through prairie grass
    ('2.25b', 126.00, 129.00, 'spicewood_act2_raw/wildlife/buck_walking_prairie.mp4', 0.0, None, 'center'),
    # 2.26a1: Rio Grande Wild Turkeys strutting past limestone wall
    ('2.26a1', 129.00, 131.40, 'spicewood_act2_raw/wildlife/wild_turkeys_grass.mp4', 0.0, None, 'center'),
    # 2.26a2: Great Egret wading in emerald Pedernales River shelves
    ('2.26a2', 131.40, 134.00, 'spicewood_act2_raw/wildlife/egret_wading_river.mp4', 0.0, None, 'center'),
    # 2.26a3: Greater Roadrunner running full tilt on caliche road
    ('2.26a3', 134.00, 137.00, 'spicewood_act2_raw/wildlife/roadrunner_running_gravel.mp4', 0.0, None, 'center'),
    # 2.26a4: Golden-Cheeked Warbler singing with beak open on cedar bough
    ('2.26a4', 137.00, 140.00, 'spicewood_act2_raw/wildlife/golden_cheeked_warbler_singing.mp4', 0.0, None, 'center'),
    # 2.26b1: Outlaws singing and clinking beers together under night sky
    ('2.26b1', 140.00, 142.40, 'spicewood_act2_raw/Act_II:_Outlaw_Anthem_&_202609031546_32.mp4', 0.0, None, 'center'),
    # 2.26b2: Glowing campfire coals stirred with iron poker
    ('2.26b2', 142.40, 145.00, 'spicewood_act2_raw/Act_II:_Outlaw_Anthem_&_202609031546_25.mp4', 0.0, None, 'center'),
    # 2.26b3: Massive roaring bonfire blazing at night
    ('2.26b3', 145.00, 150.62, 'spicewood_act2_raw/bonfire_burning_at_night_flow_8s.mp4', 0.0, None, 'center')
]

base_video = os.path.join(work_dir, 'act2_vertical_base_video.mp4')
if not os.path.exists(base_video):
    print(f'Slicing {len(shots)} Act 2 vertical 9:16 video shots (1080x1920)...')
    t0 = time.time()
    seg_files = []
    for idx, item in enumerate(shots, 1):
        ...
        mode = item[6] if len(item) > 6 else 'center'
        ...
        if max_src_t is not None:
            ...
            vf = f'[0:v]setpts={pts_scale}*PTS,scale=1080:1920:force_original_aspect_ratio=increase,crop=1080:1920:(in_w-1080)/2:0,setsar=1,fps=24,format=yuv420p[v]'
            cmd = [
                'ffmpeg', '-y',
                '-ss', str(src_in),
                '-i', src_file,
...
lyrics_timeline = [
    ...
    # 2.17: Bar 37 Speed burst (100.08 - 103.18)
    {
    ...
    # 2.18: Bar 38 Speed burst (103.18 - 106.00)
    {
    ...
    # 2.19: Bar 39 Speed burst (106.00 - 108.86)
    {
    ...
    # 2.20: Bar 40 Speed burst (108.86 - 111.52)
    {
    ...
    # 2.21: Bar 41 Speed burst (111.52 - 114.50)
    {
    ...
    # 2.22: Bar 42 Speed burst (114.50 - 116.98)
    {
    ...
    # 2.23: Bar 43 Speed burst (116.98 - 119.76)
    {
    ...
    # 2.24: Bar 44 Speed burst (119.76 - 123.20)
    {
    ...
    # 2.26a3: 134.00 - 137.00 (Tailgate toast part 3)
    {
    ...
    # 2.26b3: 145.00 - 150.62 (Roaring campfire part 3)
    {
...
print('Compositing Act 2 vertical master with 24-bit audio & karaoke overlay...')
t1 = time.time()
...
print(f'Rendered Act 2 Vertical successfully: {output_mp4} ({time.time()-t1:.1f}s)')
