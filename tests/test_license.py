...
def test_community_tier_when_trial_expired():
    ...
    config = VoiceFiConfig(tier="community", trial_started_at=expired_start)
...
def test_14_day_free_trial_active_capabilities():
    ...
    config = VoiceFiConfig(tier="community", trial_started_at=two_days_ago)
...
def test_pro_tier_capabilities():
    """Verify licensed Pro tier overrides trial and unlocks features permanently."""
...
def test_org_tier_capabilities():
    """Verify licensed Org tier overrides trial and unlocks features permanently."""
