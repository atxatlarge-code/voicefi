...
Located at [`src/voicefi/companion/static/hud_mocks.html`](file:///Users/jaketrigg/Projects/VoiceFi/src/voicefi/companion/static/hud_mocks.html).
```bash
# Open directly in your default browser:
open src/voicefi/companion/static/hud_mocks.html
...
| **Interactive HTML/CSS Design Mockup** | [`src/voicefi/companion/static/hud_mocks.html`](file:///Users/jaketrigg/Projects/VoiceFi/src/voicefi/companion/static/hud_mocks.html) |
...
1. **Iterate in HTML/CSS first:**
   Edit [`src/voicefi/companion/static/hud_mocks.html`](file:///Users/jaketrigg/Projects/VoiceFi/src/voicefi/companion/static/hud_mocks.html) with Tailwind CSS classes to experiment with spacing, colors, font sizes, glassmorphism blur, and animations.
