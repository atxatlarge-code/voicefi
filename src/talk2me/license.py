"""
License and Tier Management for Talk 2 Me.
...
class FeatureGate:
    ...
    @classmethod
    def is_pro(cls, config: Talk2MeConfig) -> bool:
    ...
    @classmethod
    def can_use_feature(cls, feature_name: str, config: Talk2MeConfig) -> bool:
    ...
    @classmethod
    def get_tier_summary(cls, config: Talk2MeConfig) -> Dict[str, Any]:
