...
CURATED_PERSONAS: List[VoicePersona] = [
    VoicePersona(
        ...
        gender="Female",
        locale="en-US",
        style="Google Gemini neural voice, breezy, warm, and expressive",
        sample_text="Hello Jake! I'm Aoede, Google Gemini's breezy and expressive voice persona.",
    ...
    VoicePersona(
        ...
        gender="Male",
        locale="en-US",
        style="Google Gemini neural voice, upbeat, energetic, and engaging",
        sample_text="Hey Jake! I'm Puck, ready to stream real-time code reviews and pair programming.",
        recommended_role="Gemini Pair Programmer / Comedy",
    ),
    VoicePersona(
        id="Charon",
        name="Charon",
        ...
        gender="Male",
        locale="en-US",
        style="Google Gemini neural voice, informative, deep, and grounded",
    ...
    VoicePersona(
        ...
        gender="Female",
        locale="en-US",
        style="Google Gemini neural voice, firm, clear, and articulate",
    ...
    VoicePersona(
        ...
        gender="Male",
        locale="en-US",
        style="Google Gemini neural voice, excitable, dynamic, and resonant",
        sample_text="Hello Jake. I'm Fenrir, dynamic and resonant companion for deep focus sessions.",
    ...
    VoicePersona(
        ...
        gender="Female",
        locale="en-US",
        style="Google Gemini neural voice, bright, clear, and uplifting",
        sample_text="Hello Jake! I'm Zephyr, bringing a bright and clear voice to your workspace.",
        recommended_role="Gemini Fast Assistant",
    ),
    VoicePersona(
        id="Leda",
        name="Leda",
        ...
        gender="Female",
        locale="en-US",
        style="Google Gemini neural voice, youthful, natural, and friendly",
        sample_text="Hey Jake! I'm Leda, a youthful and friendly voice for everyday development.",
        recommended_role="Gemini Interactive Agent",
    ),
    VoicePersona(
        id="Orus",
        name="Orus",
        ...
        gender="Male",
        locale="en-US",
        style="Google Gemini neural voice, firm, confident, and direct",
        sample_text="Greetings Jake. I am Orus, providing firm and direct engineering feedback.",
        recommended_role="Gemini Code Reviewer",
    ),
    VoicePersona(
        id="Callirrhoe",
        name="Callirrhoe",
        ...
        gender="Female",
        locale="en-US",
        style="Google Gemini neural voice, easy-going, conversational, and calm",
        sample_text="Hi Jake! I'm Callirrhoe, an easy-going partner for your coding sessions.",
    ...
    VoicePersona(
        ...
        gender="Female",
        locale="en-US",
        style="Google Gemini neural voice, bright, alert, and articulate",
        sample_text="Hello Jake. I'm Autonoe, bright and articulate for technical deep dives.",
        recommended_role="Gemini Researcher",
    ),
    VoicePersona(
        id="Enceladus",
        name="Enceladus",
        ...
        gender="Male",
        locale="en-US",
        style="Google Gemini neural voice, breathy, soft, and intimate",
        sample_text="Hello Jake. I'm Enceladus, a soft and breathy companion for quiet focus.",
        recommended_role="Gemini Focus Companion",
    ),
    VoicePersona(
        id="Iapetus",
        ...
        gender="Male",
        locale="en-US",
        style="Google Gemini neural voice, clear, structured, and distinct",
        sample_text="Greetings Jake. I am Iapetus, delivering clear and structured architecture insights.",
        recommended_role="Gemini Systems Architect",
    ),
    VoicePersona(
        id="Umbriel",
        name="Umbriel",
        ...
        gender="Male",
        locale="en-US",
        style="Google Gemini neural voice, easy-going, relaxed, and approachable",
        sample_text="Hey Jake! I'm Umbriel, relaxed and ready to help you build great software.",
        recommended_role="Gemini Pair Programmer",
    ),
    VoicePersona(
        id="Algieba",
        ...
        gender="Male",
        locale="en-US",
        style="Google Gemini neural voice, smooth, polished, and balanced",
        sample_text="Hello Jake. I'm Algieba, bringing smooth and balanced analysis to your codebase.",
        recommended_role="Gemini Code Analyst",
    ),
    VoicePersona(
        id="Despina",
        name="Despina",
        ...
        gender="Female",
        locale="en-US",
        style="Google Gemini neural voice, smooth, fluid, and melodic",
        sample_text="Hello Jake! I'm Despina, offering smooth and fluid conversational speech.",
        recommended_role="Gemini Companion",
    ),
    VoicePersona(
        id="Erinome",
        name="Erinome",
        ...
        gender="Female",
        locale="en-US",
        style="Google Gemini neural voice, clear, focused, and articulate",
        sample_text="Hello Jake. I'm Erinome, focused and clear for documentation and code walkthroughs.",
        recommended_role="Gemini Technical Writer",
    ),
    VoicePersona(
        id="Algenib",
        name="Algenib",
        ...
        gender="Male",
        locale="en-US",
        style="Google Gemini neural voice, gravelly, textured, and authoritative",
        sample_text="Greetings Jake. I am Algenib, gravelly and authoritative for systems and devops.",
        recommended_role="Gemini DevOps Lead",
    ),
    VoicePersona(
        id="Rasalgethi",
        name="Rasalgethi",
        ...
        gender="Male",
        locale="en-US",
        style="Google Gemini neural voice, informative, educational, and steady",
        sample_text="Hello Jake. I am Rasalgethi, your informative guide through complex codebases.",
        recommended_role="Gemini Tutor / Guide",
    ),
    VoicePersona(
        id="Laomedeia",
        name="Laomedeia",
        ...
        gender="Female",
        locale="en-US",
        style="Google Gemini neural voice, upbeat, lively, and optimistic",
        sample_text="Hey Jake! I'm Laomedeia, upbeat and enthusiastic about building cool things.",
        recommended_role="Gemini Interactive Agent",
    ),
    VoicePersona(
        id="Achernar",
        ...
        gender="Female",
        locale="en-US",
        style="Google Gemini neural voice, soft, gentle, and reflective",
        sample_text="Hello Jake. I'm Achernar, a gentle and reflective companion for coding flow.",
        recommended_role="Gemini Quiet Companion",
    ),
    VoicePersona(
        id="Alnilam",
        name="Alnilam",
        ...
        gender="Male",
        locale="en-US",
        style="Google Gemini neural voice, firm, solid, and commanding",
        sample_text="Greetings Jake. I am Alnilam, delivering firm command and terminal verification.",
        recommended_role="Gemini Terminal Auditor",
    ),
    VoicePersona(
        id="Schedar",
        name="Schedar",
        ...
        gender="Male",
        locale="en-US",
        style="Google Gemini neural voice, even, measured, and objective",
        sample_text="Hello Jake. I am Schedar, even and measured for rigorous quality assurance.",
        recommended_role="Gemini QA Inspector",
    ),
    VoicePersona(
        id="Gacrux",
        name="Gacrux",
        ...
        gender="Male",
        locale="en-US",
        style="Google Gemini neural voice, mature, experienced, and grounded",
        sample_text="Greetings Jake. I am Gacrux, mature and grounded guidance for senior architecture.",
        recommended_role="Gemini Senior Advisor",
    ),
    VoicePersona(
        id="Pulcherrima",
        name="Pulcherrima",
        ...
        gender="Female",
        locale="en-US",
        style="Google Gemini neural voice, forward, proactive, and energetic",
        sample_text="Hey Jake! I'm Pulcherrima, forward-looking and proactive for your milestones.",
        recommended_role="Gemini Project Manager",
    ),
    VoicePersona(
        id="Achird",
        name="Achird",
        ...
        gender="Male",
        locale="en-US",
        style="Google Gemini neural voice, friendly, warm, and collaborative",
        sample_text="Hi Jake! I'm Achird, a friendly and collaborative voice for pair programming.",
        recommended_role="Gemini Pair Programmer",
    ),
    VoicePersona(
        id="Zubenelgenubi",
        ...
        gender="Male",
        locale="en-US",
        style="Google Gemini neural voice, casual, laid-back, and natural",
        sample_text="Hey Jake, Zubenelgenubi here. Laid-back, casual, and ready to write code.",
        recommended_role="Gemini Casual Chat",
    ),
    VoicePersona(
        id="Vindemiatrix",
        name="Vindemiatrix",
        ...
        gender="Female",
        locale="en-US",
        style="Google Gemini neural voice, gentle, kind, and soothing",
        sample_text="Hello Jake. I'm Vindemiatrix, offering a gentle and supportive presence as you build.",
        recommended_role="Gemini Support Specialist",
    ),
    VoicePersona(
        id="Sadachbia",
        name="Sadachbia",
        ...
        gender="Female",
        locale="en-US",
        style="Google Gemini neural voice, lively, spirited, and engaging",
        sample_text="Hey Jake! I'm Sadachbia, lively and spirited for brainstorming and rapid prototyping.",
        recommended_role="Gemini Creative Partner",
    ),
    VoicePersona(
        id="Sadaltager",
        name="Sadaltager",
        ...
        gender="Male",
        locale="en-US",
        style="Google Gemini neural voice, knowledgeable, articulate, and insightful",
        sample_text="Greetings Jake. I am Sadaltager, knowledgeable and analytical for deep research.",
        recommended_role="Gemini Researcher / Science",
    ),
    VoicePersona(
        id="Sulafat",
        name="Sulafat",
        ...
        gender="Female",
        locale="en-US",
        style="Google Gemini neural voice, warm, rich, and reassuring",
        sample_text="Hello Jake! I'm Sulafat, bringing a warm, rich tone to your development sessions.",
        recommended_role="Gemini Primary Agent",
    ),
    VoicePersona(
        id="en-US-AvaNeural",
        name="Viv",
