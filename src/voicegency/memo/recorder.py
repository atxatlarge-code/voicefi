...
from voicegency.memo.models import MemoRecording, MemoChunk
...
class MemoBufferRecorder:
    ...
    def record_memo_session(
        ...
        if interactive:
            ...
            print("⌨️   [Enter] Finish & Synthesize  │  [Space] Pause  │  [Ctrl+C] Cancel")
            print("─" * 68 + "\n")
            ...
            while not self.stop_event.is_set():
                ...
                if elapsed >= total_target_duration and not timer_landed_handled:
                    ...
                    if interactive:
                        ...
                        # Non-interactive mode finishes at target duration
                        self.stop_event.set()
                        break
        ...
        temp_dir = Path(tempfile.gettempdir()) / "voicegency_memos"
