        ...
        with sd.InputStream(samplerate=self.sample_rate, channels=1, dtype="float32") as stream:
            ...
            while True:
                    ...
                    if self.barge_in:
                        ...
                        if smoothed_energy > barge_in_threshold:
                            ...
                            if barge_in_candidate_chunks >= 2:
                                ...
                                from voicegency.tts.base import stop_all_speech
                                stop_all_speech()
                                if on_barge_in:
                                    try:
                                        on_barge_in()
                                ...
                                # Preserve the onset speech frames so words aren't lost
                        ...
                        # Legacy mute mode: pause and discard
                        if not is_paused:
                            is_paused = True
                ...
                if is_paused and not agent_speaking:
                    # Agent just finished speaking: enter brief acoustic cooldown to let room reverb decay
                    is_paused = False
                    cooldown_remaining_chunks = 4  # ~200ms
                    running_noise_floor = 0.006
                    smoothed_energy = 0.0
                    barge_in_candidate_chunks = 0
                    agent_speaking_pre_roll.clear()
