"""
Network utilities and QR code generation for the Voicegency Mobile Companion.
...
def get_companion_urls(port: int = 8765) -> Dict[str, str]:
    """Get all candidate URLs for pairing with the mobile companion."""
    ip = get_local_ip()
...
def print_qr_code(url: str, title: str = "Voicegency Mobile Companion") -> None:
