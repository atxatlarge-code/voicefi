...
import objc
from voicegency.integrations.conversations import ConversationInfo, ConversationTracker
from voicegency.integrations.injector import focus_antigravity
...
class ConversationHubWindow:
    """Floating Activity Hub window for Voicegency."""
    ...
    def _build_panel(self):
        ...
        self._panel.setTitle_("Voicegency • Activity Hub (Persistent HUD)")
